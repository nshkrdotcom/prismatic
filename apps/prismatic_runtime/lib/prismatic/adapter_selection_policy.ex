defmodule Prismatic.AdapterSelectionPolicy do
  @moduledoc """
  Phase 6 adapter selection policy declaration for Prismatic lower simulation.

  GraphQL lower simulation is selected through owner runtime configuration only.
  """
