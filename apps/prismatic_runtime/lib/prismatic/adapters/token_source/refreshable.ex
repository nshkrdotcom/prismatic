defmodule Prismatic.Adapters.TokenSource.Refreshable do
  @moduledoc """
  Token source wrapper that refreshes expiring OAuth2 tokens through `Prismatic.OAuth2`.

  Options:

  - `:inner_source` - required wrapped token source as `{module, keyword()}` or `module`
  - `:provider` - required `Prismatic.OAuth2.Provider`
  ...
  - `:headers` - extra token-endpoint request headers
  - `:req_options` - extra request options for the HTTP client
  ...
  alias Prismatic.OAuth2.{Provider, SavedToken, Token}
