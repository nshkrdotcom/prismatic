defmodule Prismatic.OAuth2.Interactive do
  @moduledoc """
  Interactive authorization-code orchestration for OAuth2 providers.
  """

  alias Prismatic.Adapters.OAuthBrowser.SystemCmd, as: SystemBrowser
  alias Prismatic.Adapters.OAuthCallbackListener.Bandit, as: BanditCallbackListener
  alias Prismatic.OAuth2
  alias Prismatic.OAuth2.{Error, Provider}
